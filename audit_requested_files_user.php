...
$results1=$objMain->getResults("SELECT * FROM tbl_files where audior_status='no' and auditor_request='requested' ");
?>
...
<!-- Main Content -->
		...
		<div class="clearfix"></div> <article class="content-box minimizer">
			<header>
				...
				<h2>Secrect Code Requested Files List  By Auditor</h2>
					...
					<table class="datatable">
						...
						?>
							<tr class="gradeX">
                                ...
                                <td><a href="init.php?module=auditor&action=file&do=approve&id=<?php echo $res['file_id'];?>"><button class="icon"><span>Approve Request</span>
