...
$results1=$objMain->getResults("SELECT * FROM tbl_files where audior_status='no' and auditor_request='' ");
?>
					...
					<table class="datatable">
						...
						?>
							<tr class="gradeX">
                                ...
                                <td><a href="init.php?module=auditor&action=file&do=request&id=<?php echo $res['file_id'];?>"><button class="icon"><span>Secrect Code Request</span>
