...
$results1=$objMain->getResults("SELECT * FROM tbl_files where audior_status='no' and auditor_request='approved' ");
?>
...
<a href="init.php?module=auditor&action=file&do=approved&id=<?php echo $res['file_id'];?>"><button class="icon"><span>Approve</span>
