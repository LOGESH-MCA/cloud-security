...
$results1=$objMain->getResults("SELECT * FROM tbl_files where admin_status='no' and audior_status='yes' and admin_request='approved' ");
?>
...
<!-- Main Content -->
		...
		<div class="clearfix"></div> <article class="content-box minimizer">
			<header>
				...
				<h2>Secrect Code Approved Files List</h2>
...
<a href="init.php?module=admin&action=file&do=approved&id=<?php echo $res['file_id'];?>"><button class="icon"><span>Approve</span>
<img alt="Edit Page" src="img/icons/buttons/unlocked.png" border="0" >
</button></a>
<a href="init.php?module=auditor&action=file&do=rejected&id=<?php echo $res['file_id'];?>"><button class="icon"><span>DisApprove</span>
<img alt="Edit Page" src="img/icons/buttons/unlocked.png" border="0" >
</button></a></td>                                                            
							</tr>
                           <?php } } ?>
